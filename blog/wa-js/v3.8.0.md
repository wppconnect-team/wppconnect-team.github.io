...
description: Today we are releasing minor version v3.8.0 for WA-JS with We are
  announcing new privacy features in this new version, Control all privacy
  options on WPPConnect , Bug Fixes and Features.
authors: wppconnect
tags:
  - wppconnect
  - wa-js
...
Today we are releasing minor version v3.8.0 for WA-JS with We are announcing new privacy features in this new version, Control all privacy options on WPPConnect , Bug Fixes and Features.

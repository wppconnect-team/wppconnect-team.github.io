---
id: "whatsapp.WebCallModel"
title: "Class: WebCallModel"
sidebar_label: "WebCallModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).WebCallModel
...
• **new WebCallModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`WebCallModel`](whatsapp.WebCallModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:50](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L50)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L30)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L26)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L35)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/WebCallModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/WebCallModel.ts#L31)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **get**<`T`\>(`attr`): [`WebCallModel`](whatsapp.WebCallModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`WebCallModel`](whatsapp.WebCallModel.md) |
...
[`WebCallModel`](whatsapp.WebCallModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **removeAllListeners**(): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`WebCallModel`](whatsapp.WebCallModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`WebCallModel`](whatsapp.WebCallModel.md)

---
id: "whatsapp.ChatPreferenceModel"
title: "Class: ChatPreferenceModel"
sidebar_label: "ChatPreferenceModel"
...
• **new ChatPreferenceModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:51](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L51)
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:50](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L50)
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:49](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L49)
...
• `Optional` **saveToCameraRoll**: `any`

#### Inherited from

ModelProxy.saveToCameraRoll

#### Defined in

[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L29)

___

### showDoodle

• `Optional` **showDoodle**: `any`

#### Inherited from

ModelProxy.showDoodle

#### Defined in

[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L30)
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L34)

___

### wallpaperColor

• `Optional` **wallpaperColor**: `any`

#### Inherited from

ModelProxy.wallpaperColor

#### Defined in

[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L28)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **get**<`T`\>(`attr`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md) |
...
[`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)[`T`]
...
[packages/wa-js/src/whatsapp/models/ChatPreferenceModel.ts:55](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ChatPreferenceModel.ts#L55)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **removeAllListeners**(): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ChatPreferenceModel`](whatsapp.ChatPreferenceModel.md)

---
id: "whatsapp.EmojiVariantCollection"
title: "Class: EmojiVariantCollection"
sidebar_label: "EmojiVariantCollection"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).EmojiVariantCollection

**`whatsapp`** 13185

## Hierarchy

- [`Collection`](whatsapp.Collection.md)<[`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)\>
...
• **new EmojiVariantCollection**(`e?`, `t?`)
...
• **findFirst**: <S\>(`predicate`: (`this`: `void`, `value`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md), `index`: `number`, `obj`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]) => value is S, `thisArg?`: `any`) => `undefined` \| `S`(`predicate`: (`value`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md), `index`: `number`, `obj`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]) => `unknown`, `thisArg?`: `any`) => `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
| Name | Type |
| :------ | :------ |
| `S` | extends [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)<`S`\> |

##### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `predicate` | (`this`: `void`, `value`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md), `index`: `number`, `obj`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]) => value is S | find calls predicate once for each element of the array, in ascending order, until it finds one where predicate returns true. If such an element is found, find immediately returns that element value. Otherwise, find returns undefined. |
...
▸ (`predicate`, `thisArg?`): `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)

##### Parameters

| Name | Type |
| :------ | :------ |
| `predicate` | (`value`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md), `index`: `number`, `obj`: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]) => `unknown` |
| `thisArg?` | `any` |

##### Returns

`undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
• **modelClass**: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
[packages/wa-js/src/whatsapp/collections/EmojiVariantCollection.ts:24](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/EmojiVariantCollection.ts#L24)
...
▪ `Static` **model**: [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
[packages/wa-js/src/whatsapp/collections/EmojiVariantCollection.ts:23](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/EmojiVariantCollection.ts#L23)
...
▸ **add**(`value`, `options?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[] \| [`WritableProperties`](../namespaces/util.md#writableproperties)<[`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]\> |
| `options?` | `Option` |

#### Returns

[`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]
...
▸ **assertGet**(`e`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **at**(`position`): `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **emit**(`eventName`, ...`args`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **get**(`e`): `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **getModelsArray**(): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]
...
[packages/wa-js/src/whatsapp/collections/EmojiVariantCollection.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/EmojiVariantCollection.ts#L26)

___

### getVariantIfExists

▸ **getVariantIfExists**(`e?`): `any`
...
[packages/wa-js/src/whatsapp/collections/EmojiVariantCollection.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/EmojiVariantCollection.ts#L27)

___

### head

▸ **head**(): `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
| Name | Type |
| :------ | :------ |
| `model` | [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) |
| `position?` | `number` |
...
▸ **isModel**(`model`): model is EmojiVariantModel
...
▸ **last**(): `undefined` \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **remove**(`value`, `options?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[] |
| `options?` | `Object` |
...
▸ **removeAllListeners**(): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **reorder**(`e`, `t`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]
...
▸ **set**(`value`, `options?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) \| [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]
...
[packages/wa-js/src/whatsapp/collections/EmojiVariantCollection.ts:25](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/EmojiVariantCollection.ts#L25)

___

### sort

▸ **sort**(`options?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **toArray**(): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]
...
▸ **trigger**(`eventName`, ...`args`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`EmojiVariantCollection`](whatsapp.EmojiVariantCollection.md)
...
▸ **where**(`ids`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[]

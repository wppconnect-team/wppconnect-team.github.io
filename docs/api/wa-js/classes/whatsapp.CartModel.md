---
id: "whatsapp.CartModel"
title: "Class: CartModel"
sidebar_label: "CartModel"
...
• **new CartModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`CartModel`](whatsapp.CartModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L47)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L31)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L32)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L36)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L30)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`CartModel`](whatsapp.CartModel.md)
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:51](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L51)
...
▸ **emit**(`eventName`, ...`args`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **get**<`T`\>(`attr`): [`CartModel`](whatsapp.CartModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`CartModel`](whatsapp.CartModel.md) |
...
[`CartModel`](whatsapp.CartModel.md)[`T`]
...
[packages/wa-js/src/whatsapp/models/CartModel.ts:52](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CartModel.ts#L52)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **removeAllListeners**(): [`CartModel`](whatsapp.CartModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`CartModel`](whatsapp.CartModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`CartModel`](whatsapp.CartModel.md)

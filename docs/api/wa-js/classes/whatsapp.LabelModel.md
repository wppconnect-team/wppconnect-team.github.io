---
id: "whatsapp.LabelModel"
title: "Class: LabelModel"
sidebar_label: "LabelModel"
...
• **new LabelModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`LabelModel`](whatsapp.LabelModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/LabelModel.ts:51](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LabelModel.ts#L51)
...
[packages/wa-js/src/whatsapp/models/LabelModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LabelModel.ts#L26)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **get**<`T`\>(`attr`): [`LabelModel`](whatsapp.LabelModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`LabelModel`](whatsapp.LabelModel.md) |
...
[`LabelModel`](whatsapp.LabelModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **removeAllListeners**(): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`LabelModel`](whatsapp.LabelModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`LabelModel`](whatsapp.LabelModel.md)

---
id: "whatsapp.ProductCollModel"
title: "Class: ProductCollModel"
sidebar_label: "ProductCollModel"
...
• **new ProductCollModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ProductCollModel`](whatsapp.ProductCollModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:45](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L45)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L30)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L26)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L34)

___

### totalItemsCount

• `Optional` **totalItemsCount**: `any`

#### Inherited from

ModelProxy.totalItemsCount

#### Defined in

[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/ProductCollModel.ts:49](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductCollModel.ts#L49)

___

### bind

▸ **bind**(`eventName`, `listener`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **get**<`T`\>(`attr`): [`ProductCollModel`](whatsapp.ProductCollModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ProductCollModel`](whatsapp.ProductCollModel.md) |
...
[`ProductCollModel`](whatsapp.ProductCollModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **removeAllListeners**(): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ProductCollModel`](whatsapp.ProductCollModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ProductCollModel`](whatsapp.ProductCollModel.md)

---
id: "whatsapp.ProductImageModel"
title: "Class: ProductImageModel"
sidebar_label: "ProductImageModel"
...
• **new ProductImageModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ProductImageModel`](whatsapp.ProductImageModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:51](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L51)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L34)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L26)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L35)

___

### mediaUrl

• `Optional` **mediaUrl**: `any`
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L36)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:33](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L33)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L27)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:57](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L57)

___

### get

▸ **get**<`T`\>(`attr`): [`ProductImageModel`](whatsapp.ProductImageModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ProductImageModel`](whatsapp.ProductImageModel.md) |
...
[`ProductImageModel`](whatsapp.ProductImageModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:56](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L56)

___

### off

▸ **off**(`eventName?`, `listener?`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **removeAllListeners**(): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ProductImageModel`](whatsapp.ProductImageModel.md)
...
[packages/wa-js/src/whatsapp/models/ProductImageModel.ts:55](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ProductImageModel.ts#L55)

___

### unbind

▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ProductImageModel`](whatsapp.ProductImageModel.md)

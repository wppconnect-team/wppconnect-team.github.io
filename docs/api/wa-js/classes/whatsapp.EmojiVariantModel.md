---
id: "whatsapp.EmojiVariantModel"
title: "Class: EmojiVariantModel"
sidebar_label: "EmojiVariantModel"
...
• **new EmojiVariantModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`EmojiVariantModel`](whatsapp.EmojiVariantModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/EmojiVariantModel.ts:46](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/EmojiVariantModel.ts#L46)
...
[packages/wa-js/src/whatsapp/models/EmojiVariantModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/EmojiVariantModel.ts#L26)
...
[packages/wa-js/src/whatsapp/models/EmojiVariantModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/EmojiVariantModel.ts#L31)
...
[packages/wa-js/src/whatsapp/models/EmojiVariantModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/EmojiVariantModel.ts#L27)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **get**<`T`\>(`attr`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md) |
...
[`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **removeAllListeners**(): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`EmojiVariantModel`](whatsapp.EmojiVariantModel.md)

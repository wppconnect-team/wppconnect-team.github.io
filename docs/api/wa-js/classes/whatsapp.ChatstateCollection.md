---
id: "whatsapp.ChatstateCollection"
title: "Class: ChatstateCollection"
sidebar_label: "ChatstateCollection"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).ChatstateCollection
...
[packages/wa-js/src/whatsapp/collections/ChatstateCollection.ts:23](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ChatstateCollection.ts#L23)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **emit**(`eventName`, ...`args`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **removeAllListeners**(): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **sort**(`options?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ChatstateCollection`](whatsapp.ChatstateCollection.md)

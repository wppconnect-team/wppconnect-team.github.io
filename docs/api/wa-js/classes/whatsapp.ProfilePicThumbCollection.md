---
id: "whatsapp.ProfilePicThumbCollection"
title: "Class: ProfilePicThumbCollection"
sidebar_label: "ProfilePicThumbCollection"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).ProfilePicThumbCollection
...
- [`BaseCollection`](whatsapp.BaseCollection.md)<[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
• **new ProfilePicThumbCollection**(`e?`, `t?`)
...
• **findFirst**: <S\>(`predicate`: (`this`: `void`, `value`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md), `index`: `number`, `obj`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]) => value is S, `thisArg?`: `any`) => `undefined` \| `S`(`predicate`: (`value`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md), `index`: `number`, `obj`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]) => `unknown`, `thisArg?`: `any`) => `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
| Name | Type |
| :------ | :------ |
| `S` | extends [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)<`S`\> |

##### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `predicate` | (`this`: `void`, `value`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md), `index`: `number`, `obj`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]) => value is S | find calls predicate once for each element of the array, in ascending  order, until it finds one where predicate returns true. If such an element is found, find  immediately returns that element value. Otherwise, find returns undefined. |
...
▸ (`predicate`, `thisArg?`): `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)

##### Parameters

| Name | Type |
| :------ | :------ |
| `predicate` | (`value`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md), `index`: `number`, `obj`: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]) => `unknown` |
| `thisArg?` | `any` |

##### Returns

`undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
• **modelClass**: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▪ `Static` **model**: [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:25](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L25)
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L27)
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L26)
...
▸ **add**(`value`, `options?`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[] \| [`WritableProperties`](../namespaces/util.md#writableproperties)<[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]\> |
| `options?` | `Option` |

#### Returns

[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
▸ **assertGet**(`e`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▸ **at**(`position`): `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **emit**(`eventName`, ...`args`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **find**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
[`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
▸ **findQuery**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<`undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
[`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<`undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L30)

___

### gadd

▸ **gadd**(`id`, `options?`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `id` | `Stringable` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) |
| `options?` | `any` |
...
▸ **gaddUp**(`id`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▸ **get**(`e`): `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▸ **getModelsArray**(): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
### getThumbnailWidFromVcard

▸ **getThumbnailWidFromVcard**(`e?`): `any`
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L31)
...
| Name | Type |
| :------ | :------ |
| `values` | [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[] |
...
▸ **head**(): `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L28)
...
| Name | Type |
| :------ | :------ |
| `model` | [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) |
| `position?` | `number` |
...
| Name | Type |
| :------ | :------ |
| `value` | [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[] |
...
▸ **isModel**(`model`): model is ProfilePicThumbModel
...
▸ **last**(): `undefined` \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **remove**(`value`, `options?`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
▸ **removeAllListeners**(): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **reorder**(`e`, `t`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
[packages/wa-js/src/whatsapp/collections/ProfilePicThumbCollection.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/ProfilePicThumbCollection.ts#L29)
...
▸ **set**(`value`, `options?`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md) \| [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
▸ **sort**(`options?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **toArray**(): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]
...
▸ **trigger**(`eventName`, ...`args`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ProfilePicThumbCollection`](whatsapp.ProfilePicThumbCollection.md)
...
▸ **update**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)\>
...
▸ **where**(`ids`): [`ProfilePicThumbModel`](whatsapp.ProfilePicThumbModel.md)[]

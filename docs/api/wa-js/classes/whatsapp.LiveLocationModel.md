---
id: "whatsapp.LiveLocationModel"
title: "Class: LiveLocationModel"
sidebar_label: "LiveLocationModel"
...
- [`Model`](whatsapp.Model.md)<[`LiveLocationCollection`](whatsapp.LiveLocationCollection.md)\>
...
• **new LiveLocationModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`LiveLocationModel`](whatsapp.LiveLocationModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:48](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L48)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L34)
...
• `Optional` **collection**: [`LiveLocationCollection`](whatsapp.LiveLocationCollection.md)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L47)
...
• `Optional` **keepAliveTimer**: `any`

#### Inherited from

ModelProxy.keepAliveTimer

#### Defined in

[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L35)
...
| `change:id` | `number` |
| `change:keepAliveTimer` | `undefined` \| `number` |
| `change:stale` | `undefined` \| `number` |
| `change:stopPromise` | `undefined` \| `number` |
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:52](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L52)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:33](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L33)

___

### stopPromise

• `Optional` **stopPromise**: `any`

#### Inherited from

ModelProxy.stopPromise

#### Defined in

[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L36)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **get**<`T`\>(`attr`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`LiveLocationModel`](whatsapp.LiveLocationModel.md) |
...
[`LiveLocationModel`](whatsapp.LiveLocationModel.md)[`T`]
...
▸ **getCollection**(): [`LiveLocationCollection`](whatsapp.LiveLocationCollection.md)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:59](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L59)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:53](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L53)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:57](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L57)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **removeAllListeners**(): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:54](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L54)

___

### stopListening

▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:58](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L58)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:55](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L55)
...
▸ **trigger**(`eventName`, ...`args`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`LiveLocationModel`](whatsapp.LiveLocationModel.md)
...
[packages/wa-js/src/whatsapp/models/LiveLocationModel.ts:56](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/LiveLocationModel.ts#L56)

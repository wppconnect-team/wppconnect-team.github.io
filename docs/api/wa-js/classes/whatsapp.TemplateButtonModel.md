---
id: "whatsapp.TemplateButtonModel"
title: "Class: TemplateButtonModel"
sidebar_label: "TemplateButtonModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).TemplateButtonModel
...
• **new TemplateButtonModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`TemplateButtonModel`](whatsapp.TemplateButtonModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L47)
...
ModelProxy.displayText

#### Defined in

[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L26)
...
ModelProxy.phoneNumber

#### Defined in

[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L30)
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L36)

___

### selectionId

• `Optional` **selectionId**: `any`

#### Inherited from

ModelProxy.selectionId

#### Defined in

[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L31)
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L35)
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/TemplateButtonModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/TemplateButtonModel.ts#L29)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **get**<`T`\>(`attr`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md) |
...
[`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **removeAllListeners**(): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`TemplateButtonModel`](whatsapp.TemplateButtonModel.md)

---
id: "whatsapp.ReplyButtonModel"
title: "Class: ReplyButtonModel"
sidebar_label: "ReplyButtonModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).ReplyButtonModel
...
• **new ReplyButtonModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ReplyButtonModel`](whatsapp.ReplyButtonModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ReplyButtonModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ReplyButtonModel.ts#L47)
...
[packages/wa-js/src/whatsapp/models/ReplyButtonModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ReplyButtonModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/ReplyButtonModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ReplyButtonModel.ts#L26)
...
[packages/wa-js/src/whatsapp/models/ReplyButtonModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ReplyButtonModel.ts#L32)
...
[packages/wa-js/src/whatsapp/models/ReplyButtonModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ReplyButtonModel.ts#L31)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **get**<`T`\>(`attr`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md) |
...
[`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **removeAllListeners**(): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ReplyButtonModel`](whatsapp.ReplyButtonModel.md)

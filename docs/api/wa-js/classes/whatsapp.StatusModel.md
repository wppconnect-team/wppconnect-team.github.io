---
id: "whatsapp.StatusModel"
title: "Class: StatusModel"
sidebar_label: "StatusModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).StatusModel
...
- [`Model`](whatsapp.Model.md)<[`StatusCollection`](whatsapp.StatusCollection.md)\>
...
• **new StatusModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`StatusModel`](whatsapp.StatusModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:45](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L45)
...
• `Optional` **collection**: [`StatusCollection`](whatsapp.StatusCollection.md)
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:44](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L44)
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:33](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L33)
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L29)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **get**<`T`\>(`attr`): [`StatusModel`](whatsapp.StatusModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`StatusModel`](whatsapp.StatusModel.md) |
...
[`StatusModel`](whatsapp.StatusModel.md)[`T`]
...
▸ **getCollection**(): [`StatusCollection`](whatsapp.StatusCollection.md)
...
[packages/wa-js/src/whatsapp/models/StatusModel.ts:49](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/StatusModel.ts#L49)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **removeAllListeners**(): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`StatusModel`](whatsapp.StatusModel.md)

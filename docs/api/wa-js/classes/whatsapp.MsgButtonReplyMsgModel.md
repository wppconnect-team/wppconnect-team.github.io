---
id: "whatsapp.MsgButtonReplyMsgModel"
title: "Class: MsgButtonReplyMsgModel"
sidebar_label: "MsgButtonReplyMsgModel"
...
- [`Model`](whatsapp.Model.md)
  ...
  ↳ **`MsgButtonReplyMsgModel`**

## Constructors

### constructor

• **new MsgButtonReplyMsgModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/MsgButtonReplyMsgModel.ts:48](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/MsgButtonReplyMsgModel.ts#L48)
...
[packages/wa-js/src/whatsapp/models/MsgButtonReplyMsgModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/MsgButtonReplyMsgModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/MsgButtonReplyMsgModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/MsgButtonReplyMsgModel.ts#L47)
...
[packages/wa-js/src/whatsapp/models/MsgButtonReplyMsgModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/MsgButtonReplyMsgModel.ts#L32)

___

### unsyncedButtonReplies

• `Optional` **unsyncedButtonReplies**: `any`

#### Inherited from

ModelProxy.unsyncedButtonReplies

#### Defined in

[packages/wa-js/src/whatsapp/models/MsgButtonReplyMsgModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/MsgButtonReplyMsgModel.ts#L28)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **get**<`T`\>(`attr`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md) |
...
[`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **removeAllListeners**(): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`MsgButtonReplyMsgModel`](whatsapp.MsgButtonReplyMsgModel.md)

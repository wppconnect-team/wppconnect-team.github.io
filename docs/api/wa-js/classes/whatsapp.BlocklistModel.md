---
id: "whatsapp.BlocklistModel"
title: "Class: BlocklistModel"
sidebar_label: "BlocklistModel"
...
- [`Model`](whatsapp.Model.md)<[`BlocklistCollection`](whatsapp.BlocklistCollection.md)\>
...
• **new BlocklistModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`BlocklistModel`](whatsapp.BlocklistModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:44](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L44)
...
• `Optional` **collection**: [`BlocklistCollection`](whatsapp.BlocklistCollection.md)
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:43](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L43)
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L32)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:48](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L48)
...
▸ **emit**(`eventName`, ...`args`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **get**<`T`\>(`attr`): [`BlocklistModel`](whatsapp.BlocklistModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`BlocklistModel`](whatsapp.BlocklistModel.md) |
...
[`BlocklistModel`](whatsapp.BlocklistModel.md)[`T`]
...
▸ **getCollection**(): [`BlocklistCollection`](whatsapp.BlocklistCollection.md)
...
[packages/wa-js/src/whatsapp/models/BlocklistModel.ts:49](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/BlocklistModel.ts#L49)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **removeAllListeners**(): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`BlocklistModel`](whatsapp.BlocklistModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`BlocklistModel`](whatsapp.BlocklistModel.md)

---
id: "whatsapp.BusinessProfileCollection"
title: "Class: BusinessProfileCollection"
sidebar_label: "BusinessProfileCollection"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).BusinessProfileCollection
...
- [`Collection`](whatsapp.Collection.md)<[`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)\>
...
• **new BusinessProfileCollection**(`e?`, `t?`)
...
• **findFirst**: <S\>(`predicate`: (`this`: `void`, `value`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md), `index`: `number`, `obj`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]) => value is S, `thisArg?`: `any`) => `undefined` \| `S`(`predicate`: (`value`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md), `index`: `number`, `obj`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]) => `unknown`, `thisArg?`: `any`) => `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
| Name | Type |
| :------ | :------ |
| `S` | extends [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)<`S`\> |

##### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `predicate` | (`this`: `void`, `value`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md), `index`: `number`, `obj`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]) => value is S | find calls predicate once for each element of the array, in ascending order, until it finds one where predicate returns true. If such an element is found, find immediately returns that element value. Otherwise, find returns undefined. |
...
▸ (`predicate`, `thisArg?`): `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)

##### Parameters

| Name | Type |
| :------ | :------ |
| `predicate` | (`value`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md), `index`: `number`, `obj`: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]) => `unknown` |
| `thisArg?` | `any` |

##### Returns

`undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
• **modelClass**: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
▪ `Static` **model**: [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
[packages/wa-js/src/whatsapp/collections/BusinessProfileCollection.ts:25](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/BusinessProfileCollection.ts#L25)
...
[packages/wa-js/src/whatsapp/collections/BusinessProfileCollection.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/BusinessProfileCollection.ts#L26)
...
▸ **add**(`value`, `options?`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[] \| [`WritableProperties`](../namespaces/util.md#writableproperties)<[`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]\> |
| `options?` | `Option` |

#### Returns

[`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]
...
▸ **assertGet**(`e`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
▸ **at**(`position`): `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **emit**(`eventName`, ...`args`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
[packages/wa-js/src/whatsapp/collections/BusinessProfileCollection.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/BusinessProfileCollection.ts#L27)

___

### get

▸ **get**(`e`): `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
▸ **getModelsArray**(): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]
...
[packages/wa-js/src/whatsapp/collections/BusinessProfileCollection.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/BusinessProfileCollection.ts#L29)

___

### head

▸ **head**(): `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
| Name | Type |
| :------ | :------ |
| `model` | [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) |
| `position?` | `number` |
...
▸ **isModel**(`model`): model is BusinessProfileModel
...
▸ **last**(): `undefined` \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
[packages/wa-js/src/whatsapp/collections/BusinessProfileCollection.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/BusinessProfileCollection.ts#L28)

___

### once

▸ **once**(`eventName`, `listener`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **remove**(`value`, `options?`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[] |
| `options?` | `Object` |
...
▸ **removeAllListeners**(): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **reorder**(`e`, `t`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]
...
▸ **set**(`value`, `options?`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md) \| [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]
...
▸ **sort**(`options?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **toArray**(): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]
...
▸ **trigger**(`eventName`, ...`args`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`BusinessProfileCollection`](whatsapp.BusinessProfileCollection.md)
...
▸ **where**(`ids`): [`BusinessProfileModel`](whatsapp.BusinessProfileModel.md)[]

---
id: "whatsapp.MsgLoadState"
title: "Class: MsgLoadState"
sidebar_label: "MsgLoadState"
...
• **new MsgLoadState**(`proterties?`, `options?`)
...
[packages/wa-js/src/whatsapp/misc/MsgLoadState.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/misc/MsgLoadState.ts#L27)
...
[packages/wa-js/src/whatsapp/misc/MsgLoadState.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/misc/MsgLoadState.ts#L26)
...
[packages/wa-js/src/whatsapp/misc/MsgLoadState.ts:24](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/misc/MsgLoadState.ts#L24)
...
[packages/wa-js/src/whatsapp/misc/MsgLoadState.ts:25](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/misc/MsgLoadState.ts#L25)
...
[packages/wa-js/src/whatsapp/misc/MsgLoadState.ts:23](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/misc/MsgLoadState.ts#L23)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **emit**(`eventName`, ...`args`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **get**<`T`\>(`attr`): [`MsgLoadState`](whatsapp.MsgLoadState.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`MsgLoadState`](whatsapp.MsgLoadState.md) |
...
[`MsgLoadState`](whatsapp.MsgLoadState.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **removeAllListeners**(): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **trigger**(`eventName`, ...`args`): [`MsgLoadState`](whatsapp.MsgLoadState.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`MsgLoadState`](whatsapp.MsgLoadState.md)

---
id: "whatsapp.CallParticipantModel"
title: "Class: CallParticipantModel"
sidebar_label: "CallParticipantModel"
...
• **new CallParticipantModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`CallParticipantModel`](whatsapp.CallParticipantModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:59](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L59)
...
[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L26)
...
ModelProxy.isIncoming

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L28)
...
ModelProxy.isInterrupted

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L30)

___

### isInvitingToGroupCall

• **isInvitingToGroupCall**: `boolean`

#### Inherited from

ModelProxy.isInvitingToGroupCall

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:33](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L33)
...
[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L31)

___

### isOfferingVideoUpgrade

• **isOfferingVideoUpgrade**: `boolean`

#### Inherited from

ModelProxy.isOfferingVideoUpgrade

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:38](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L38)
...
ModelProxy.isRinging

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L29)
...
ModelProxy.isTrafficStopped

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L32)
...
ModelProxy.isVideoDecodePaused

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L36)

___

### isVideoDecodeStarted

• **isVideoDecodeStarted**: `boolean`

#### Inherited from

ModelProxy.isVideoDecodeStarted

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:37](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L37)
...
ModelProxy.isVideoPaused

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L35)
...
ModelProxy.isVideoStopped

#### Defined in

[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L34)
...
| Name | Type |
| :------ | :------ |
| `change:callId` | `undefined` \| `number` |
| `change:id` | `undefined` \| `number` |
| `change:isIncoming` | `number` |
| `change:isInterrupted` | `number` |
| `change:isInvitingToGroupCall` | `number` |
| `change:isMuted` | `number` |
| `change:isOfferingVideoUpgrade` | `number` |
| `change:isRinging` | `number` |
| `change:isTrafficStopped` | `number` |
| `change:isVideoDecodePaused` | `number` |
| `change:isVideoDecodeStarted` | `number` |
| `change:isVideoPaused` | `number` |
| `change:isVideoStopped` | `number` |
...
[packages/wa-js/src/whatsapp/models/CallParticipantModel.ts:42](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/CallParticipantModel.ts#L42)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **get**<`T`\>(`attr`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`CallParticipantModel`](whatsapp.CallParticipantModel.md) |
...
[`CallParticipantModel`](whatsapp.CallParticipantModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **removeAllListeners**(): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`CallParticipantModel`](whatsapp.CallParticipantModel.md)

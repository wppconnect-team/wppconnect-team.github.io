---
id: "whatsapp.ConversionTupleModel"
title: "Class: ConversionTupleModel"
sidebar_label: "ConversionTupleModel"
...
- [`Model`](whatsapp.Model.md)
  ...
  ↳ **`ConversionTupleModel`**

## Constructors

### constructor

• **new ConversionTupleModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ConversionTupleModel`](whatsapp.ConversionTupleModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L47)

## Properties

### alarmId

• `Optional` **alarmId**: `any`
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L35)
...
• `Optional` **conversionData**: `any`

#### Inherited from

ModelProxy.conversionData

#### Defined in

[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L28)

___

### conversionSource

• `Optional` **conversionSource**: `any`

#### Inherited from

ModelProxy.conversionSource

#### Defined in

[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:46](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L46)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L34)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L30)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:51](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L51)

___

### emit

▸ **emit**(`eventName`, ...`args`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:52](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L52)

___

### get

▸ **get**<`T`\>(`attr`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md) |
...
[`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)[`T`]
...
[packages/wa-js/src/whatsapp/models/ConversionTupleModel.ts:53](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ConversionTupleModel.ts#L53)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **removeAllListeners**(): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ConversionTupleModel`](whatsapp.ConversionTupleModel.md)

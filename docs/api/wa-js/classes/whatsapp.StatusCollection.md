---
id: "whatsapp.StatusCollection"
title: "Class: StatusCollection"
sidebar_label: "StatusCollection"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).StatusCollection
...
- [`BaseCollection`](whatsapp.BaseCollection.md)<[`StatusModel`](whatsapp.StatusModel.md)\>
...
• **findFirst**: <S\>(`predicate`: (`this`: `void`, `value`: [`StatusModel`](whatsapp.StatusModel.md), `index`: `number`, `obj`: [`StatusModel`](whatsapp.StatusModel.md)[]) => value is S, `thisArg?`: `any`) => `undefined` \| `S`(`predicate`: (`value`: [`StatusModel`](whatsapp.StatusModel.md), `index`: `number`, `obj`: [`StatusModel`](whatsapp.StatusModel.md)[]) => `unknown`, `thisArg?`: `any`) => `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
| Name | Type |
| :------ | :------ |
| `S` | extends [`StatusModel`](whatsapp.StatusModel.md)<`S`\> |

##### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `predicate` | (`this`: `void`, `value`: [`StatusModel`](whatsapp.StatusModel.md), `index`: `number`, `obj`: [`StatusModel`](whatsapp.StatusModel.md)[]) => value is S | find calls predicate once for each element of the array, in ascending  order, until it finds one where predicate returns true. If such an element is found, find  immediately returns that element value. Otherwise, find returns undefined. |
...
▸ (`predicate`, `thisArg?`): `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)

##### Parameters

| Name | Type |
| :------ | :------ |
| `predicate` | (`value`: [`StatusModel`](whatsapp.StatusModel.md), `index`: `number`, `obj`: [`StatusModel`](whatsapp.StatusModel.md)[]) => `unknown` |
| `thisArg?` | `any` |

##### Returns

`undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
• **modelClass**: [`StatusModel`](whatsapp.StatusModel.md)
...
▪ `Static` **idClass**: typeof [`Wid`](whatsapp.Wid.md)

#### Defined in

[packages/wa-js/src/whatsapp/collections/StatusCollection.ts:25](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/StatusCollection.ts#L25)

___

### model

▪ `Static` **model**: [`StatusModel`](whatsapp.StatusModel.md)
...
[packages/wa-js/src/whatsapp/collections/StatusCollection.ts:24](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/StatusCollection.ts#L24)
...
[packages/wa-js/src/whatsapp/collections/StatusCollection.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/StatusCollection.ts#L27)
...
[packages/wa-js/src/whatsapp/collections/StatusCollection.ts:26](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/collections/StatusCollection.ts#L26)
...
▸ **add**(`value`, `options?`): [`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[] \| [`WritableProperties`](../namespaces/util.md#writableproperties)<[`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[]\> |
| `options?` | `Option` |

#### Returns

[`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[]
...
▸ **assertGet**(`e`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **at**(`position`): `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **emit**(`eventName`, ...`args`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **find**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`StatusModel`](whatsapp.StatusModel.md)\>
...
[`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`StatusModel`](whatsapp.StatusModel.md)\>
...
▸ **findQuery**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<`undefined` \| [`StatusModel`](whatsapp.StatusModel.md)\>
...
[`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<`undefined` \| [`StatusModel`](whatsapp.StatusModel.md)\>
...
▸ **gadd**(`id`, `options?`): [`StatusModel`](whatsapp.StatusModel.md)

#### Parameters

| Name | Type |
| :------ | :------ |
| `id` | `Stringable` \| [`StatusModel`](whatsapp.StatusModel.md) |
| `options?` | `any` |
...
▸ **gaddUp**(`id`): [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **get**(`e`): `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **getModelsArray**(): [`StatusModel`](whatsapp.StatusModel.md)[]
...
| Name | Type |
| :------ | :------ |
| `values` | [`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[] |
...
▸ **head**(): `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
| Name | Type |
| :------ | :------ |
| `model` | [`StatusModel`](whatsapp.StatusModel.md) |
| `position?` | `number` |
...
| Name | Type |
| :------ | :------ |
| `value` | [`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[] |
...
▸ **isModel**(`model`): model is StatusModel
...
▸ **last**(): `undefined` \| [`StatusModel`](whatsapp.StatusModel.md)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **remove**(`value`, `options?`): [`StatusModel`](whatsapp.StatusModel.md)[]
...
▸ **removeAllListeners**(): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **reorder**(`e`, `t`): [`StatusModel`](whatsapp.StatusModel.md)[]
...
▸ **set**(`value`, `options?`): [`StatusModel`](whatsapp.StatusModel.md) \| [`StatusModel`](whatsapp.StatusModel.md)[]
...
▸ **sort**(`options?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **toArray**(): [`StatusModel`](whatsapp.StatusModel.md)[]
...
▸ **trigger**(`eventName`, ...`args`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`StatusCollection`](whatsapp.StatusCollection.md)
...
▸ **update**(`id`, `options?`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`StatusModel`](whatsapp.StatusModel.md)\>
...
▸ **where**(`ids`): [`StatusModel`](whatsapp.StatusModel.md)[]

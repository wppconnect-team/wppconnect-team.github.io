---
id: "whatsapp.OrderItemModel"
title: "Class: OrderItemModel"
sidebar_label: "OrderItemModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).OrderItemModel
...
• **new OrderItemModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`OrderItemModel`](whatsapp.OrderItemModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:53](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L53)
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L27)
...
• `Optional` `Readonly` **mediaData**: `any`
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:40](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L40)
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L28)
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:30](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L30)
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:36](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L36)

___

### thumbnailId

• `Optional` **thumbnailId**: `any`

#### Inherited from

ModelProxy.thumbnailId

#### Defined in

[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:31](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L31)

___

### thumbnailUrl

• `Optional` **thumbnailUrl**: `any`

#### Inherited from

ModelProxy.thumbnailUrl

#### Defined in

[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:32](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L32)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **get**<`T`\>(`attr`): [`OrderItemModel`](whatsapp.OrderItemModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`OrderItemModel`](whatsapp.OrderItemModel.md) |
...
[`OrderItemModel`](whatsapp.OrderItemModel.md)[`T`]
...
[packages/wa-js/src/whatsapp/models/OrderItemModel.ts:57](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/OrderItemModel.ts#L57)
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **removeAllListeners**(): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`OrderItemModel`](whatsapp.OrderItemModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`OrderItemModel`](whatsapp.OrderItemModel.md)

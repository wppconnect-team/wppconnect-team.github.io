---
id: "whatsapp.ParticipantModel"
title: "Class: ParticipantModel"
sidebar_label: "ParticipantModel"
custom_edit_url: null
---

[whatsapp](../namespaces/whatsapp.md).ParticipantModel
...
• **new ParticipantModel**(`proterties?`, `options?`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `proterties?` | [`ModelPropertiesContructor`](../namespaces/whatsapp.md#modelpropertiescontructor)<[`ParticipantModel`](whatsapp.ParticipantModel.md), `any`\> |
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:47](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L47)
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:34](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L34)
...
ModelProxy.hasSenderKey

#### Defined in

[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:35](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L35)
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:27](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L27)
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:46](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L46)
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:28](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L28)
...
ModelProxy.isSuperAdmin

#### Defined in

[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:29](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L29)
...
[packages/wa-js/src/whatsapp/models/ParticipantModel.ts:33](https://github.com/wppconnect-team/wa-js/blob/main/src/whatsapp/models/ParticipantModel.ts#L33)
...
▸ **bind**(`eventName`, `listener`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **emit**(`eventName`, ...`args`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **get**<`T`\>(`attr`): [`ParticipantModel`](whatsapp.ParticipantModel.md)[`T`]

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends keyof [`ParticipantModel`](whatsapp.ParticipantModel.md) |
...
[`ParticipantModel`](whatsapp.ParticipantModel.md)[`T`]
...
▸ **listenTo**(`context`, `eventName`, `listener?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **listenToAndRun**(`context`, `eventName`, `listener?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **listenToOnce**(`context`, `eventName`, `listener?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **off**(`eventName?`, `listener?`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **on**(`eventName`, `listener`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **once**(`eventName`, `listener`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **removeAllListeners**(): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **removeListener**(`eventName?`, `listener?`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **stopListening**(`context?`, `eventName?`, `listener?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **trigger**(`eventName`, ...`args`): [`ParticipantModel`](whatsapp.ParticipantModel.md)
...
▸ **unbind**(`eventName?`, `listener?`, `context?`): [`ParticipantModel`](whatsapp.ParticipantModel.md)

...
- [EventTypes](../interfaces/chat.EventTypes.md)
...
[packages/wa-js/src/chat/eventEmitter.ts:24](https://github.com/wppconnect-team/wa-js/blob/main/src/chat/eventEmitter.ts#L24)
...
| Name | Type |
| :------ | :------ |
| `Name` | extends keyof [`EventTypes`](../interfaces/chat.EventTypes.md) |
...
| :------ | :------ |
| `eventName` | `Name` |
| `listener` | (`eventData`: [`EventTypes`](../interfaces/chat.EventTypes.md)[`Name`]) => `void` \| [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<`void`\> |
...
• **on**<`Name`\>(`eventName`, `listener`): [`UnsubscribeFn`](chat.md#unsubscribefn)
...
[`UnsubscribeFn`](chat.md#unsubscribefn)
...
• **once**<`Name`\>(`eventName`): [`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`EventTypes`](../interfaces/chat.EventTypes.md)[`Name`]\>
...
[`Promise`]( https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise )<[`EventTypes`](../interfaces/chat.EventTypes.md)[`Name`]\>
